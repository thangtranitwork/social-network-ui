...
export default function ChatLayout() {
  ...
  // ✅ Khi URL có chatId → chọn đúng cuộc trò chuyện
  useEffect(() => {
  ...
  // Sau khi tạo chat mới → update URL và list
  ...
  // Quay về danh sách → xóa chatId khỏi URL
